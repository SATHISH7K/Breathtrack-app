...
if (!empty($image_base64)) {
    ...
    $file_name = $upload_dir . 'pft_report_' . time() . '_' . rand(100, 999) . '.jpg';
...
try {
    ...
    $stmt = $conn->prepare("
        INSERT INTO pft_values (patient_id, normal, mild, moderate, severe, comments, image_path, created_at)
    ...
    echo json_encode(["status" => "success", "message" => "PFT report submitted successfully"]);
