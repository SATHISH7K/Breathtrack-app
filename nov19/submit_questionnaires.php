...
try {
    ...
    $check = $conn->prepare("SELECT * FROM questionnaires WHERE patient_id = :pid LIMIT 1");
    ...
    if($existing){
        $update = $conn->prepare("
            UPDATE questionnaires SET
                ...
                q1_cough=:q1,q2_phlegm=:q2,q3_chest_tightness=:q3,
                q4_breathlessness=:q4,q5_activity_limitation=:q5,
                q6_confidence_leaving_home=:q6,q7_sleep_quality=:q7,
                q8_energy_level=:q8,average_score=:avg,updated_at=NOW()
        ...
        echo json_encode(["status"=>"success","message"=>"Questionnaire updated","patient_id"=>$patient_id,"average_score"=>$average_score]);
    } else {
        $insert = $conn->prepare("
            INSERT INTO questionnaires (
                patient_id,date_pneumococcal,date_flu,date_pertussis,
                ...
                q7_sleep_quality,q8_energy_level,average_score,
                created_at,updated_at
            ) VALUES (
                :pid,:dp,:df,:dpe,:ds1,:ds2,
                :q1,:q2,:q3,:q4,:q5,:q6,:q7,:q8,:avg,NOW(),NOW()
            )
        ");
        $insert->execute([
            ':pid'=>$patient_id,
        ...
        echo json_encode(["status"=>"success","message"=>"Questionnaire submitted","patient_id"=>$patient_id,"average_score"=>$average_score]);
    }
